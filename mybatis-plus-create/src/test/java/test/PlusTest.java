...
=======
				"jdbc:mysql://127.0.0.1:3306/demo?useUnicode=true&characterEncoding=utf8&allowMultiQueries=true&serverTimezone=Asia/Shanghai&useSSL=false",
				"root", "root").globalConfig(builder -> {
					builder.author("cw") // 设置作者
>>>>>>> 5b27481 (init)
